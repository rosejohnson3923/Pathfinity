...
export function LearningModes({ todaysLessons, lessonsLoading, onLessonComplete, totalRemainingTime }: LearningModesProps) {
    ...
    <div className="space-y-4">
      <div className="flex flex-col space-y-2">
        ...
        {totalRemainingTime > 0 && (
          <div className="flex items-center space-x-2 bg-blue-100 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg px-3 py-1.5 animate-pulse-slow">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex space-x-2">
                        <button 
                          ...
                          className="flex items-center space-x-1 px-2 py-1 bg-green-600 text-white rounded text-xs font-medium hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          <CheckCircle className="w-3 h-3" />
                          <span>Complete</span>
                        </button>
                        <button className="flex items-center space-x-1 px-2 py-1 bg-blue-600 text-white rounded text-xs font-medium hover:bg-blue-700 transition-colors">
                      ...
                      {mode.todaysAssignments.slice(1).map((assignment, index) => (
                        <div key={index} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                          ...
                          <div className="flex space-x-2">
                            ...
                            <button className="flex items-center space-x-1 px-2 py-1 bg-gray-600 text-white rounded text-xs font-medium hover:bg-gray-700 transition-colors">
                              <Play className="w-3 h-3" />
                              <span>Start</span>
                            </button>
                          </div>
