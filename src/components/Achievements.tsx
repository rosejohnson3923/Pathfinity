  ...
  const loadAchievements = async () => {
    try {
      ...
      const [userAchievements, availableAchievements] = await Promise.allSettled([
        ...
        GamificationService.getAvailableAchievements(tenantId)
      ]);
        ...
        availableAchievementsData.forEach(achievement => {
          if (achievement && achievement.id) {
            ...
            allAchievements.push({
              ...
              earnedDate: userAchievement?.earned_at || undefined,
      ...
      // If no achievements from API, use fallback data
